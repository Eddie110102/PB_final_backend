...
router.post("/addComment", async (req, res) => {
  ...
  let addComment = await con.queryAsync("INSERT INTO course_comment (user_id,content,course_id) VALUES (?,?,?)",[user_id,text,course_id]);
...
router.post("/addChildrenComment", async (req, res) => {
  ...
  let addComment = await con.queryAsync("INSERT INTO response_comment (user_id,content,course_comment_id) VALUES (?,?,?)",[user_id,text,course_comment_id]);
